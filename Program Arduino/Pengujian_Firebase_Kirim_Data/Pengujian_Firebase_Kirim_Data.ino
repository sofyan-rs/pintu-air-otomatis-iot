/*
 * Program untuk mengirim data ke Firebase
 * Sofyan R. - 191311030
 */
...
void loop() {
  ...
  if (Firebase.ready()) {
    ...
    float dataInput = 20;
    Firebase.setFloat(firebaseData, pathTest + "/data_input", dataInput);
    Serial.println("Mengirim nilai " + (String)dataInput + " ke Firebase");
  } else {
    initFirebase();
  }
}
